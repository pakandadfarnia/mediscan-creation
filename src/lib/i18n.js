...
const D = {
  ...
  "safety.duplicate": { en: "Duplicate active ingredient", es: "Ingrediente activo duplicado", fr: "Ingrédient actif dupliqué", zh: "重复活性成分", pt: "Ingrediente ativo duplicado", ar: "مكون نشط مكرر" },
  "safety.duplicateMsg": { en: "Shares “{x}” with {others}.", es: "Comparte «{x}» con {others}.", fr: "Partage « {x} » avec {others}.", zh: "与 {others} 共享“{x}”。", pt: "Compartilha “{x}” com {others}.", ar: "يشارك «{x}» مع {others}." },
  "safety.with": { en: "With {med}", es: "Con {med}", fr: "Avec {med}", zh: "与 {med}", pt: "Com {med}", ar: "مع {med}" },
  "safety.drugDrug": { en: "Drug–drug", es: "Fármaco-fármaco", fr: "Médicament-médicament", zh: "药物相互作用", pt: "Fármaco-fármaco", ar: "بين الأدوية" },
  ...
  "safety.noIssues": { en: "No safety issues found.", es: "No se encontraron problemas de seguridad.", fr: "Aucun problème de sécurité.", zh: "未发现安全问题。", pt: "Nenhum problema de segurança.", ar: "لا توجد مشاكل أمان." },
  ...
  "allergyWarn.desc": { en: "This medication contains inactive ingredients that match your recorded allergies:", es: "Este medicamento contiene ingredientes inactivos que coinciden con tus alergias:", fr: "Ce médicament contient des ingrédients inactifs correspondant à vos allergies:", zh: "此药物含有与您记录的过敏原匹配的非活性成分：", pt: "Este medicamento contém ingredientes inativos que correspondem às suas alergias:", ar: "يحتوي هذا الدواء على مكونات غير نشطة تطابق حساساتك المسجلة:" },
  "dupWarn.title": { en: "Duplicate active ingredient", es: "Ingrediente activo duplicado", fr: "Ingrédient actif dupliqué", zh: "重复活性成分", pt: "Ingrediente ativo duplicado", ar: "مكون نشط مكرر" },
  "dupWarn.desc": { en: "This medication shares an active ingredient with something already on your list. Taking both can cause an accidental overdose.", es: "Este medicamento comparte un ingrediente activo con algo ya en tu lista. Tomar ambos puede causar una sobredosis accidental.", fr: "Ce médicament partage un ingrédient actif avec un autre de votre liste. Les prendre ensemble peut provoquer un surdosage.", zh: "此药物与列表中的另一种药物共享活性成分。同时服用可能导致意外过量。", pt: "Este medicamento compartilha um ingrediente ativo com algo já na sua lista. Tomar ambos pode causar sobredosagem acidental.", ar: "يشارك هذا الدواء مكونًا نشطًا مع دواء آخر في قائمتك. تناولهما معًا قد يسبب جرعة زائدة عرضية." },
};
