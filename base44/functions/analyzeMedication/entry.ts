  ...
  try {
    ...
    const result = await base44.asServiceRole.integrations.Core.InvokeLLM({
      prompt:
        ...
        "Write 'side_effects' and 'warnings' in plain, everyday words a non-doctor can understand — avoid medical jargon. For example say 'may make you sleepy' instead of 'may cause sedation', and 'may upset your stomach' instead of 'may cause gastrointestinal disturbance'. " +
